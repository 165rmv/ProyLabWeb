...
exports.seed = async function(knex) {
  ...
  await knex('productos').insert([
    ...
    {nombre: 'cara_feliz', tipo: 'playera', genero: 'M', precio: 250.00, descripcion: 'Playera amarilla con una cara feliz.', img: 'https://firebasestorage.googleapis.com/v0/b/aesthetic-fashion-4a9dd.appspot.com/o/fotosProductos%2FplayeraCaraFeliz.jpg?alt=media&token=4b816db1-f1a1-4206-8e79-062fb836ef1b'},
    {nombre: 'sencilla_blanca_cc', tipo: 'playera', genero: 'M', precio: 200.00, descripcion: 'Playera blanca sin estampado con cuello circular.', img: 'https://firebasestorage.googleapis.com/v0/b/aesthetic-fashion-4a9dd.appspot.com/o/fotosProductos%2FplayeraBlanca.jpg?alt=media&token=f8f62157-cb58-47c2-a6a9-f23a36f67fbb'},
    {nombre: 'short_mezclilla', tipo: 'short', genero: 'M', precio: 299.99, descripcion: 'Short de mezclilla desgastado.', img: 'https://firebasestorage.googleapis.com/v0/b/aesthetic-fashion-4a9dd.appspot.com/o/fotosProductos%2FshortMezclilla.jpg?alt=media&token=210e4197-e049-4053-a2c1-bab6eb5b99b5'},
    {nombre: 'pantalon_mezclilla_negro', tipo: 'pantalon', genero: 'H', precio: 560.26, descripcion: 'Pantalon de mezclilla de color negro.', img: 'https://firebasestorage.googleapis.com/v0/b/aesthetic-fashion-4a9dd.appspot.com/o/fotosProductos%2FMezcillaNegra.jpg?alt=media&token=77995649-b47d-41af-ab39-591f3b8106aa'},
    {nombre: 'spiderman_caricatura', tipo: 'playera', genero: 'H', precio: 410.15, descripcion: 'Playera de Spiderman en caricatura.', img: 'https://firebasestorage.googleapis.com/v0/b/aesthetic-fashion-4a9dd.appspot.com/o/fotosProductos%2FplayeraSpiderman.jpg?alt=media&token=cf6f5437-c022-4772-8e4f-6a6bfb5dc8e5'},
    {nombre: 'negro_sencillo_cc', tipo: 'playera', genero: 'H', precio: 200.00, descripcion: 'Playera de color negro con cuello circular.', img: 'https://firebasestorage.googleapis.com/v0/b/aesthetic-fashion-4a9dd.appspot.com/o/fotosProductos%2FplayeraNegra.jpg?alt=media&token=9b58cb29-dee3-4dd6-9d9c-4794513c33fe'}
  ]);
